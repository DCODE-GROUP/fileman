<section class="p-6">
    <div class="flex flex-row justify-start gap-2 items-center">
        ...
        <fileman-add-folder-popup class="ml-auto"
        ...
        @if(count($folders) > 0)
            @foreach ($folders as $folder)
                <a href="{{route('fileman.folder.index',$folder->id)  }}">
                    <div class="flex flex-row gap-2 py-4 px-3 bg-gray-50 rounded-xl hover:bg-gray-100">
                        <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 stroke-gray-500">
